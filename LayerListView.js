...
define([
  ...
  domClass, domStyle, NlsStrings, _AttachMixin, Menu, MenuItem, registry, ComboButton, LayerSelector) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _AttachMixin], {
    ...
    postCreate: function() {
        var layersArray = [];
            layersArray = this.operLayerInfos.getLayerInfoArray();
        var count = 0;
